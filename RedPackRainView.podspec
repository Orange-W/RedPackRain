#
#  Be sure to run `pod spec lint RedPackRainView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "RedPackRain/Classes/*.swift"
  ...
  # s.framework  = "SomeFramework"
   s.frameworks = "UIKit", "Foundation", "AVFoundation", "AudioToolbox"
